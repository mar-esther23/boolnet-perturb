...
attractor2dataframe <- function(attr, sep="/", node.names=NULL, Boolean=FALSE) {
    if (Boolean) {
...
#' attractors2dataframe(attrs)
attractors2dataframe <- function(attr.list, sep='/', returnDataFrame=c('occurrence','basinSize'), ...) {
